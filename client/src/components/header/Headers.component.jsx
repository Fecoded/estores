                ...
                <div className="col-md-6">
                	<div className="d-flex align-items-center justify-content-center justify-content-md-start">
                        <ul className="contact_detail text-center text-lg-left">
                            <li><i className="ti-mobile"></i><span>+(234) 8167163048</span></li>
                        </ul>
                    </div>
                </div>
                <div className="col-md-6">
    	...
    	<div className="container">
            <nav className="navbar navbar-expand-lg"> 
                <a className="navbar-brand " href="index.html">
                    <img className="s-50 " src={logo} alt="logo"/>
                </a>
                    ...
                    <ul className="navbar-nav">
                        <li className="dropdown">
                            ...
                            <div className="dropdown-menu">
                                <ul> 
                                    <li><a className="dropdown-item nav-link nav_item active" href="index.html">Fashion 1</a></li>
